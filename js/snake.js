    ...
    */
    ...
    return function(inputConfig) {
        ...
        function createWelcomeElement() {
            ...
            welcomeTxt.innerHTML = "HIPAA Snake<p></p>You left a door open (green box) behind you on your way to HIPAA training (red box), Close it now to prevent any intruder to get access to sensible information. Use the <strong>arrow keys</strong> on your keyboard to play the game.<p></p>";
